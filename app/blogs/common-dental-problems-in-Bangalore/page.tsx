...
export default function RegularDentalCheckups() {
  const latestBlogs = [
    ...
    { title: "Why Max Align is one of the Best Dental Clinics in Marathahalli", img: "/assets/1.webp", link: "/blogs/max-align-best-dental-clinic", date: "13-07-2025" },
    { title: "Top 5 Benefits of Professional Teeth Whitening", img: "/assets/2.webp", link: "/blogs/professional-teeth-whitening", date: "19-07-2025" },
