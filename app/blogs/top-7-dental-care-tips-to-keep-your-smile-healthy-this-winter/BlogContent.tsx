          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <article className="md:col-span-2 bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
              <div className="overflow-hidden">
                <Image
                  src="/assets/4.webp"
                  alt="Top 7 Dental Care Tips To Keep Your Smile Healthy This Winter"
                  width={900}
                  height={450}
              ...
              <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
                ...
                <h3 className="text-2xl font-bold text-[#0B7A75]">Introduction: Your Smile’s Winter Shield at MaxAlign</h3>
                <p>
                ...
                <h3 className="text-2xl font-bold text-[#0B7A75]">
                  I. Combat Cold-Induced Sensitivity with Precision
                </h3>
                <p>
                ...
                <h3 className="text-2xl font-bold text-[#0B7A75]">
                  II. Prevent Dry Mouth and Protect Gums
                </h3>
                <p>
                ...
                <h3 className="text-2xl font-bold text-[#0B7A75]">
                  III. Elevate Your Oral Care Routine for the Season
                </h3>
                <p>
                ...
                <h3 className="text-2xl font-bold text-[#0B7A75]">
                  IV. Protect Gums in Winter from Inflammation
                </h3>
                <p>
                ...
                <h3 className="text-2xl font-bold text-[#0B7A75]">
                  V. Navigate Festive Sugars with Preventive Care
                </h3>
                <p>
                ...
                <h3 className="text-2xl font-bold text-[#0B7A75]">
                  VI. Shield Your Lips and Oral Tissues
                </h3>
                <p>
                ...
                <h3 className="text-2xl font-bold text-[#0B7A75]">
                  VII. Schedule a Mid-Winter Checkup at MaxAlign
                </h3>
                <p>
                ...
                <p>
                  Get a radiant smile that can withstand any weather! Visit MaxAlign Clinic now and shine well!
                </p>
                ...
                <div className="mt-12 space-y-8">
                  <h3 className="text-3xl font-bold text-[#0B7A75]">Frequently Asked Questions</h3>
                  
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 border-l-4 border-[#0B7A75] pl-4">Why do I feel pain in my teeth during cold weather?</h4>
                      <p className="mt-2 text-gray-700">Well, generally, it is caused by the expansion and relaxation of gums. However, we recommend using the prescribed toothpaste and dental care from MaxAlign’s doctors.</p>
                    </div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 border-l-4 border-[#0B7A75] pl-4">What’s the frequency of taking oral care during winter?</h4>
                      <p className="mt-2 text-gray-700">It is recommended to visit MaxAlign at least once every six months for a healthy teeth in winter and an advanced oral care routine.</p>
                    </div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 border-l-4 border-[#0B7A75] pl-4">Can dry mouth really cause cavities?</h4>
                      <p className="mt-2 text-gray-700">Without saliva, gums may face inflammation. Later, it leads to a decrease in blood circulation to the gum and then forms a cavity.</p>
                    </div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 border-l-4 border-[#0B7A75] pl-4">How can I protect my child’s teeth during winter?</h4>
                      <p className="mt-2 text-gray-700">Our experts suggest brushing your child’s teeth thoroughly and ensuring that he/she should consume any sugary items. For children, we always recommend getting an appointment and establishing a comprehensive oral healthcare routine.</p>
                    </div>
                  </div>
                </div>
              </div>
